              ...
              <div class="col-md-6 col-md-offset-3">
                <div class="demo-form-wrapper">
                  <form data-toggle="validator" method="post">
                    <div class="alert alert-info" style="background: white;border: 1px solid #efa406">
                      
                      <img src="<?= base_url() ?>assets/bitcoin.png" width="180" height="40" align="center">
                    </div>
                    ...
                    <div class="form-group has-feedback">
                      <label for="address" class="control-label">Bitcoin wallet address</label>
                      <input id="address" class="form-control" type="text" name="address" minlength="33" data-msg-length="Please enter a valid bitcoin address." data-msg-required="Please enter your bitcoin address." required>
                      <span class="form-control-feedback" aria-hidden="true">
                        <span class="icon"></span>
                      </span>
                      <small class="help-block">The provided bitcoin address will be used on payment of interest. Make sure it is a valid address.</small>
                    </div>
                    <div class="form-group has-feedback">
                      <label for="amount" class="control-label">Deposit amount (0.00 USD) worth of Bitcoin(BTC)</label>
                      <input id="amount" class="form-control" type="decimal" name="amount" autocomplete="off" data-msg-required="Please enter the deposit amount." required>
                      <span class="form-control-feedback" aria-hidden="true">
                        <span class="icon"></span>
                      </span>
                    ...
                    <div class="form-group">
                      <button type="submit" class="btn btn-primary btn-block">Make deposit</button>
                    </div>
                  </form>
                </div>
              </div>
